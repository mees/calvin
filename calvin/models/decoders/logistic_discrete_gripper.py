...
class LogisticDiscreteGripperPolicyNetwork(ActionDecoder):
    def __init__(
        self,
        visual_features: int,
        ...
        super(LogisticDiscreteGripperPolicyNetwork, self).__init__()
    ...
    def _setup_action_bounds(self, dataset_dir, act_max_bound, act_min_bound, load_action_bounds):
        if load_action_bounds:
            try:
                statistics_path = Path(calvin.__file__).parent / dataset_dir / "training/statistics.yaml"
